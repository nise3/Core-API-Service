...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'rabbitmq' => [
            'driver' => 'rabbitmq',
            'queue' => env('RABBITMQ_QUEUE','core.q'),
            ...
            'options' => [
                'queue' => [
                    'exchange' => env('RABBITMQ_EXCHANGE_NAME','core.x'),
                    'exchange_type' => env('RABBITMQ_EXCHANGE_TYPE','topic'),
                    'exchange_routing_key' => env('EXCHANGE_ROUTING_KEY','core.routing.key'),
                ...
                'exchange' => [
                    'name' => env('RABBITMQ_EXCHANGE_NAME','core.x'),
                ...
                'alternate_exchange' => [
                    'name' => env('RABBITMQ_ALTERNATE_EXCHANGE', 'core.alternate.x'),
                    'type' => env('RABBITMQ_ALTERNATE_EXCHANGE_TYPE','fanout'),
                    'queue' => env('RABBITMQ_ALTERNATE_QUEUE','core.alternate.q')
                ],
                'dlx' => [
                    'name' => env('RABBITMQ_RETRY_DLX', 'core.dlx'),
                    'type' => env('RABBITMQ_RETRY_DLX_TYPE', 'fanout'),
                    'dlq' => env('RABBITMQ_RETRY_DLQ', 'core.dlq'),
