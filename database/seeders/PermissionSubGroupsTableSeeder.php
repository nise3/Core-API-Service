...
class PermissionSubGroupsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('permission_sub_groups')->insert([
            ...
            array('id' => '13','permission_group_id' => '8','title_en' => '4IR Permission Sub Group 1','title' => '৪ আই আর পারমিশন সাব গ্রুপ  ১','key' => '4ir_permission_sub-group','row_status' => '1','created_at' => '2022-05-19 21:29:17','updated_at' => '2022-05-19 21:29:31')
        ]);
