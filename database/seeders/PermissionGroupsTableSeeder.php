...
class PermissionGroupsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('permission_groups')->insert(array(
            array('id' => '1','title_en' => 'System Admin Permission Group','title' => 'সিস্টেম অ্যাডমিন পারমিশন গ্রুপ','key' => 'system','row_status' => '1','created_at' => '2022-01-05 16:53:45','updated_at' => '2022-02-10 18:34:46'),
            ...
            array('id' => '8','title_en' => '4IR Permission Group','title' => '4 আই আর পারমিশন গ্রুপ','key' => '4ir_permission_group','row_status' => '1','created_at' => '2022-05-19 21:24:03','updated_at' => '2022-05-19 21:24:03')
        ));
