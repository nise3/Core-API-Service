...
class DomainsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('domains')->insert([
            ...
            array('domain' => 'smef.nise3.xyz', 'institute_id' => NULL, 'organization_id' => NULL, 'industry_association_id' => 3,'title_prefix'=>'SMEF-DEV' , 'title_prefix_en'=>'SMEF-DEV', 'created_at' => '2022-01-30 18:00:34', 'updated_at' => '2022-01-30 18:00:34'),
